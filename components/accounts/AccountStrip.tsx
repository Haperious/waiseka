...
import { ChevronDown, ChevronUp, Settings, RefreshCw, Landmark, CreditCard, PiggyBank, Banknote, Smartphone, Wallet } from 'lucide-react'
        ...
        <div style={{ display: 'flex', gap: 2, position: 'relative' }} ref={settingsRef}>
          <button
            ...
            style={{
              ...
              border: 'none', backgroundColor: 'transparent', color: 'var(--color-text-muted)', cursor: 'pointer',
            }}
          >
                ...
                <>
                  {accounts.map((account) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span style={{ fontSize: '0.78rem', color: 'var(--color-text-primary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {account.name}
                        </span>
                      </label>
                    )
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: 'var(--color-accent)', fontSize: '0.75rem', fontWeight: 600, cursor: 'pointer',
                      textAlign: 'center',
                    }}
                  >
                    Show all
          ...
          {accountsError ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 2px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none', backgroundColor: 'transparent',
                  color: 'var(--color-accent)', fontSize: '0.78rem', fontWeight: 600, cursor: 'pointer',
                }}
              >
            ...
            <div
              style={{
                ...
                WebkitOverflowScrolling: 'touch', scrollSnapType: 'x proximity', paddingBottom: 2,
              }}
            >
