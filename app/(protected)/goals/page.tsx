  ...
  return (
    <div style={{ position: "relative", width: 96, height: 96 }}>
      <svg viewBox="0 0 96 96" style={{ width: "100%", height: "100%", transform: "rotate(-90deg)" }}>
        <circle cx="48" cy="48" r={r} fill="none" stroke="var(--color-elevated)" strokeWidth="7" />
        <circle
          cx="48"
          cy="48"
          r={r}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        >
          ...
          {!isCompleted && !isPaused && (
            ...
            >
              {isOverdue ? t("goal.overdue") : `${daysLeft}d`}
            </span>
          )}
        </div>
      </div>
  ...
  return (
    <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {showCapBanner && (
        ...
        >
          ...
          <p style={{ fontSize: "0.82rem", color: "var(--color-accent)", flex: 1, lineHeight: 1.5 }}>
            You&apos;ve reached the free plan limit of 3 active goals. <strong>Upgrade to Premium</strong> to track
            unlimited goals.
          </p>
          <button
      ...
      {loading ? (
        ...
        >
          <p style={{ fontSize: "0.88rem", color: "var(--color-text-muted)" }}>{t("goal.createFirst")}</p>
